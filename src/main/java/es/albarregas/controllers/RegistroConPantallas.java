 ...
 * @author Jesús
 */
@WebServlet(name = "RegistroConPantallas", urlPatterns = {"/RegistroConPantallas"})
public class RegistroConPantallas extends HttpServlet {
    ...
    private final String[] errores = {"nombre", "usuario", "contraseña", "Fecha de nacimiento incorrecta"};
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("enviar") == null && request.getParameter("volver") == null) {
            ...
            for (int i = 0; i < errores.length; i++) {
                ...
                if (codError < 3) {
                    out.println("El campo " + errores[codError] + " es obligatorio</p>");
                } else {
                    out.println(errores[codError] + "</p>");
                }
            }
            out.println("</div>");
    ...
    private void cuerpoVacio(PrintWriter out, HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < 4; i++) {
            ...
            sb.append("<td><input type=\"checkbox\" name=\"prefe").append(i).append("\" " + "value=\"").append(preferencias[i]).append("\" ").append(valor).append(" /></td><td>").append(preferencias[i]).append("</td></tr>");
        }
